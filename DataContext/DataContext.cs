...
namespace Data
{
    public class DataContext : IdentityDbContext<User>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                var connString = "Data Source= (localdb)\\MSSQLLocalDB; Initial Catalog=PromocodeAppData";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // SEED FOR TEST
            var appUser = new User("test@test.com")
            {
           ...
           var services = new Faker<Service>()
                ...
                .RuleFor(s => s.ImageUrl, f => f.Image.PicsumUrl(width: 120, height: 120))
                .RuleFor(s => s.Status, f => f.Random.Bool(.75f))
                .RuleFor(s => s.Description, f => f.Lorem.Paragraphs(f.Random.Int(1, 3))).Generate(20);
